...
public class Constants {
        ...
        public static final String EXAMS_USERID="select * from quiz_exams where userId=";
        ...
        public static final String EXAM_ID_USER_ID = " and userId=";
        public static final String EXAM_LAST_INSERT = "select last_insert_id()";
}
