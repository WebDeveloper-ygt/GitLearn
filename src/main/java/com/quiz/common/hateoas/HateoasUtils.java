...
public class HateoasUtils {
    ...
    public static Response timeoutException() {
        return Response.status(Response.Status.REQUEST_TIMEOUT).entity(
                new ExceptionBean("Request Timeout exception", 408, "We could not process the request within time, please check your internet speed", exceptionLink))
                .build();
    }
}
